...
<?php if($adminActiveSection === "sales-studio"){ ?>
    ...
    <script
        defer
        src="<?php echo htmlspecialchars($baseurl . "admin-sales-studio-marketplace-copy.js?v=2", ENT_QUOTES, "UTF-8"); ?>"
    ></script>
    <script
        defer
        src="<?php echo htmlspecialchars($baseurl . "admin-sales-studio-flow-ui.js?v=1", ENT_QUOTES, "UTF-8"); ?>"
    ></script>
<?php } ?>
